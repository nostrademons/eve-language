...
{
       9,     0,    -1,    10,    -1,     3,    -1,    10,     5,    10,
      -1,    10,     4,    10,    -1,    10,     7,    10,    -1,    10,
       6,    10,    -1
};
...
{
  "$end", "error", "$undefined", "NUM", "MINUS", "PLUS", "DIVIDE",
  "TIMES", "$accept", "program", "exp", 0
};
#endif
...
/* Line 1455 of yacc.c  */
#line 18 "parser.y"
    { yyget_extra(scanner)->_result = (yyvsp[(1) - (1)]); }
    break;
